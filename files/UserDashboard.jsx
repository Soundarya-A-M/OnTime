...
import { MapPin, Ticket, Clock, TrendingUp, Eye } from 'lucide-react';
...
const UserDashboard = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20 px-4 pb-12">
            ...
            {viewingTicket && (
                <ETicket booking={viewingTicket} onClose={() => setViewingTicket(null)} />
            )}
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 mb-8">
                    <Link to="/track" className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition group">
                    ...
                    <Link to="/book-ticket" className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition group">
                    ...
                    <Link to="/track" className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition group">
                        ...
                        <p className="text-gray-300">Check bus timings and live ETAs</p>
                    </Link>
                </div>
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-4 text-xs text-gray-400">
                                                ...
                                                {booking.amount > 0 && <span>₹{booking.amount}</span>}
